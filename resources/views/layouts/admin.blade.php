<div class="min-h-screen bg-gray-100">
    ...
    <div class="flex space-x-4">
        <aside
            class="flex flex-col w-64 h-screen px-5 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                ...
                <nav class="-mx-3 space-y-6 ">
                    ...
                    <div class="space-y-3 ">
                        ...
                        <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                            ...
                            <span class="mx-2 text-sm font-medium">Downloadable Contents</span>
                        </a>
